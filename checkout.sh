...
git clone git@github.com:pip-services-iot/pip-services-beacons-node.git
...
git clone git@github.com:pip-services-iot/pip-clients-positions-node.git
git clone git@github.com:pip-services-iot/pip-services-routes-node.git
git clone git@github.com:pip-services-iot/pip-clients-routes-node.git
git clone git@github.com:pip-services-iot/pip-services-routeanalysis-node.git
git clone git@github.com:pip-services-iot/pip-clients-routeanalysis-node.git
